...
// v1: писал время заезда СРАЗУ по нажатию кнопки в переменную, а на флешку -
//     когда вставят. Но водитель может тупить минуту с флешкой, и время
//     заезда получалось "враньём". Переделано дома под все условия:
//     время берётся В МОМЕНТ записи на карту, из защищённых часов App.Vremya.
// v2: таймер делал через Thread.Sleep(15000) - окно замерзало намертво :)
//     заменил на DispatcherTimer, UI живой.
// --------------------------------------
