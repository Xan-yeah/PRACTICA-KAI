...
// Если у ЭВМ сядет батарейка CMOS (время реально сбивается из CMOS) или
// кто-то переведёт часы ОС, то расчёт стоимости сломается. Поэтому:
...
// Хранить "последнее время" в файле недостаточно - такой способ не ловит
// перевод стрелок во время работы, поэтому выбран именно TickCount.
// ============================================================================
